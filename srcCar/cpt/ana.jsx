    ...
    render(){
        ...
        return(
            <div className = 'AnaChoiceCom'>
                <ChoiceCon handleChange = {this.handleChange} data={{labelName: '品牌',conId: 'brand',choice:[{id: 'audi', text: '奥迪'},{id: 'benchi', text: '奔驰'}]}}/>
                <ChoiceCon handleChange = {this.handleChange} data={{labelName: '外形',conId: 'shape',choice:[{id: 'suv', text: 'SUV'},{id: 'car', text: '轿车'}]}}/>
                <ChoiceCon handleChange = {this.handleChange} data={{labelName: '车型',conId: 'model', choice:[{id: 'Q7', text: '奥迪Q7'},{id: 'Q8', text: '奥迪Q8'}]}}/>
                <ChoiceCon handleChange = {this.handleChange} data={{labelName: '区域',conId: 'area',choice:[{id: 'east', text: '东区'},{id: 'north', text: '北区'}]}}/>
            </div>        
            )
    }
}
